...
public class 황은지_Accountbook extends JPanel{
	...
	public 황은지_Accountbook() {
		...
		setLayout(null);
		this.setSize(Window_interface_D.diary_table.getPreferredSize().width -20,Window_interface_D.diary_table.getPreferredSize().height -30);
		...
		panel_3.setBounds(28, 215, 1497, 707);
		add(panel_3);
		...
		scrollPane_1.setBounds(316, 34, 200, 56);
		...
		//라벨버튼 추가
		Labela la1 = new Labela("금액숨기기");
		la1.setFont(new Font("Nanum Pen", Font.BOLD, 14));
		la1.setBackground(new Color(230, 223, 224));
		la1.setBounds(528, 30, 80, 26);
		panel_3.add(la1);
		
		Labela la1_1 = new Labela("금액보이기");
		la1_1.setFont(new Font("Nanum Pen", Font.BOLD, 15));
		la1_1.setBackground(new Color(230, 223, 224));
		la1_1.setBounds(528, 63, 80, 26);
		panel_3.add(la1_1);
		
		Labela la1_2 = new Labela("금액숨기기");
		la1_2.setFont(new Font("Nanum Pen", Font.BOLD, 14));
		la1_2.setBackground(new Color(230, 223, 224));
		la1_2.setBounds(988, 30, 80, 26);
		panel_3.add(la1_2);
		
		Labela la1_3 = new Labela("금액보이기");
		la1_3.setFont(new Font("Nanum Pen", Font.BOLD, 14));
		la1_3.setBackground(new Color(230, 223, 224));
		...
		*/
		...
		panel_2.setBounds(12, 33, 265, 623);
		...
		panel_8.setBounds(1, 1, this.getWidth()-2, 60);
		add(panel_8);
		...
		lblNewLabel_2.setBounds(1273, 10, 247, 40);
		...
		panel_6.setBounds(20, 70, this.getWidth()-40, 121);
		add(panel_6);
		...
		Labela la1_4 = new Labela("위시리스트 추가하기");
		la1_4.setBounds(1129, 33, 130, 65);
		panel_6.add(la1_4);
		...
		Labela la1_4_1 = new Labela("위시리스트 보기");
		la1_4_1.setFont(new Font("Nanum Pen", Font.BOLD, 18));
		la1_4_1.setBorder(new BevelBorder(BevelBorder.RAISED));
		la1_4_1.setBackground(new Color(215, 192, 174));
		la1_4_1.setBounds(1296, 33, 130, 65);
