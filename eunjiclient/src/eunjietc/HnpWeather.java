	...
	public static String get(int x, int y, String[] v)
	{
		...
		try
		{
			...
			URL url = new URL(
				...
				+ "?ServiceKey=wiLuPkhoEGKfKZI40BR0qLo2m5prazeMnvg82m70%2B39eYg6dHcYOSAWAvpxbORAwaEFbcr0xBnCNpOS%2FodUH6A%3D%3D" // 서비스키
