...
public class Calcul extends JPanel implements ActionListener {
	...
	public Calcul() {
		...
		this.setBackground(new Color(217, 186, 176));
		...
		display.setBackground(new Color(254, 244, 243));
		...
		btnplus.setBackground(new Color(220, 202, 194));
        ...
        displaypanel.setBackground(new Color(192, 141, 120));
        buttonpanel.setBackground(new Color(199, 154, 139));
        debugpanel.setBackground(new Color(181, 142, 125));
