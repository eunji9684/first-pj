...
public class Window_D_Panel_Center extends JPanel {
	...
	public Window_D_Panel_Center(BorderLayout layout,int x,int y ,int width,int height){
    ...
    protected void paintComponent(Graphics g) {
        ...
        if(Window_interface_D.option.main_panel_center_border_rownd) {
            ...
            graphics2d.fillRoundRect(
            		...
            		Window_interface_D.option.main_panel_center_width_rownd,
            		Window_interface_D.option.main_panel_center_height_rownd		
            );
