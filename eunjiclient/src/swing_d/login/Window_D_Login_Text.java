...
public class Window_D_Login_Text extends JTextField{
	int x;
	int y;
	int width;
	int height;
	...
	public Window_D_Login_Text(int x, int y, int location_x , int location_y, int width , int height, float fontsize){
		...
		addKeyListener(new KeyAdapter() {
			public void keyReleased(KeyEvent e) {
				...
				key = getText().isEmpty();
				Window_interface_D.login_Text.repaint();
