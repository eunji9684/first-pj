...
public class Window_D_Login_Label extends JLabel {
	...
	public Window_D_Login_Label(String a,int x,int y ,int location_x , int location_y ,int width,int height, float fontsize){
