...
public class Window_D_Login_Circle_btn extends JLabel {

	int width;
	int height;
	String a;
	float font_size;
	public Window_D_Login_Circle_btn(Runnable run , String a, float font_size ,int x, int y, int width, int height){
